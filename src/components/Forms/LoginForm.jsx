...
export default function LoginForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md p-8 border border-gray-700 rounded">
                ...
                <p className="text-sm text-center mb-4">
                    <Link href="/forgot-password" className="underline text-blue-400 hover:text-blue-300 cursor-pointer">
                ...
                <p className="my-4 text-center">
                    Don't have an account? <Link href="/register" className="underline cursor-pointer text-blue-400 hover:text-blue-300">Register</Link>
                </p>
