        ...
        <div className="min-h-screen flex items-center justify-center bg-white text-black">
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md p-8 border border-black/10 rounded">
                ...
                <p className="text-sm text-center mb-4">
                    <Link href="/forgot-password" className="underline text-indigo-600 cursor-pointer">
                ...
                <p className="my-4 text-center">
                    Don't have an account? <Link href="/register" className="underline cursor-pointer">Register</Link>
                </p>
